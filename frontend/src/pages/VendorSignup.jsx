...
export default function VendorSignup() {
  ...
  const categories = ["Catering", "Decoration", "Lighting", "Photography"];
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      ...
      login(user);
      toast.success(`Welcome, ${formData.name}! Your vendor account is ready.`);
      navigate("/vendor");
      setLoading(false);
    }, 800);
  };
      ...
      >
        ...
        <div className="mt-4 p-4 bg-white rounded-lg border border-neutral-200">
          <p className="text-sm text-neutral-600 text-center">
            Select a category to display on the right side panel
          </p>
